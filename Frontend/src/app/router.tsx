...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        errorElement: <RouteErrorBoundary />,
        lazy: async () => {
          const { SearchResultsPage } = await import('@/features/search/routes/SearchResultsPage')
      ...
      },
      {
        ...
        errorElement: <RouteErrorBoundary />,
        lazy: async () => {
          const { CampaignListPage } = await import('@/features/campaigns/routes/CampaignListPage')
        ...
        children: [
          {
            ...
            errorElement: <RouteErrorBoundary />,
            lazy: async () => {
              const { CallDetailDrawer } = await import('@/features/calls/routes/CallDetailDrawer')
  ...
  },
  {
    /* The compliance gate is full-width with no shell panes, so it is declared a
       ...
       way means fighting the shell with CSS forever. */
